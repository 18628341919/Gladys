...
你有可能认为，批量式练习者会比交错式练者/随机练习者更快学会。因此研究人员让他们马上停止练习，批量式练习者似乎更胜一筹。但是，相反地，练习者在10天以后返回，并且在批量式、交错式及随机顺序条件下进行再次测试。在随机测试条件下，交错式练习者远比批量式练者表现更好，批量式练习者在随机测试条件下，实际什么也没掌握。在批量测试条件下，两组练习方式者的表现基本相当，但交错式练习者略占上风。
