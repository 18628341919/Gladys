...
交错式主题学习是极好学习的方法，它采用间隔学习和交替学习。在一项经典交错与批量对照实验中（Shea＆Morgan，1979），测试者分为三组，以三种不同的方式练习，要求测试者都以规定的顺序快速击中六个障碍物中的三个。三组测试者都练习18次，在交错练习对照组中，可以任意决定指定的实验的练习。而在批量练习对照组中，一整套练习需一次完成。
